async function loadProduct() {
  ...
  try {
    ...
    const response = await fetch(`https://trendfit-backend.onrender.com/api/products/${productId}`);
    ...
    <img src="https://trendfit-backend.onrender.com${product.image}" alt="${product.name}" style="width:300px; height:auto; border-radius: 8px;">
    ...
    product.colors.forEach((color) => {
      ...
      if (isValidColor) {
        ...
        colorDiv.classList.add("invalid");
        colorDiv.title = "Invalid color";
      }
